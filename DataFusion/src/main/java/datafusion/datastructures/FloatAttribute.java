...
/**
 * A Float Attribute is instantiated version of the Attribute parent class in
 * which the values of the attribute are floating point numbers. Despite the
 * fact that floating point numbers can represent the Reals, a continuous set, a
 * FloatAttribute can still be a categorical Attribute, meaning that it can take
 * on one of a finite set of floating point numbers.
 */
public class FloatAttribute extends Attribute {
	...
	/**
	 * Constructor for the Float Attribute class. Uses deterministic regex rules to
	 * parse the string and convert it to a float. *
	 * 
	...
	/**
	 * The hash code combines the name and formatted string of the float together
	 * and hashes that value
	 * 
	 * @return
	 */
	@Override
	...
	/**
	 * Returns true iff the two attrs have the same name and have the same float
	 * value
	 * 
	...
	public boolean equals(Object obj) {
		return (obj instanceof FloatAttribute) && this.name.equals(((FloatAttribute) obj).getName())
				&& this.floatValue == ((FloatAttribute) obj).getFloatValue();
	}

	/**
	 * Allows storage of a normalized version of the floating point number Useful if
	 * one applies normalization to the data and wants to maintain both the original
