...
import main.java.datafusion.util.Functions;
...
public class TruthFinder extends Algorithm {
    ...
    private HashMap<Source, Double> sourceTrustWorthiness;
    ...
    public TruthFinder(String name) {
        ...
        this.rho = 0.3;
        this.gamma = 0.1;
        sourceTrustWorthiness = new HashMap<Source, Double>();
    }
    ...
    public ArrayList<Result> execute(RecordCollection collection) {
        ...
        /* 
         * Save trustworthiness value 
        */
        for (Source s : sources) {
            sourceTrustWorthiness.put(s, previousTrustworthiness.get(s));
        }
        return results;
    }
    ...
    public double getSourceTrustworthiness(Source s) {
    	return sourceTrustWorthiness.get(s);
    }
